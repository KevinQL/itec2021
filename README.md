...
@PáginaItec :tada: Página de presentación para el instituto el Tecnológico :shipit:
- [x] pagina de presentación e informativa :+1:.
- [x] Presenta de un módulo para verificar los certificados de manera virtual  :+1:.
- [x] Presenta los diferentes cursos que se imparte con los links de formulario para la inscripción virtual :+1:.
- [x] Implementa la Api de facebook y Wsp para la comunicación con los asistentes de Itec :+1:. 
...
* 🚀  Puedes visitar el proyecto si aún está disponible [Itec web](https://www.eltecnologico.com.pe/Web/?pg=web)
...
# Screenshot System 🌱:
* 🚀  Cargando la página
![imagen login sistema](https://github.com/KevinQL/itec2021/blob/main/public/__filesproject/cargaPagina.PNG)
* 🚀  Página inicio Itec
![imagen login sistema](https://github.com/KevinQL/itec2021/blob/main/public/__filesproject/itecweb.png)
* 🚀  Módulo validar certificado de cursos estudiantes.
![imagen login sistema](https://github.com/KevinQL/itec2021/blob/main/public/__filesproject/mod_validar.png)
* 🚀  Página quienes somos.
![imagen login sistema](https://github.com/KevinQL/itec2021/blob/main/public/__filesproject/seccionSomos.png)
